...
## 2. First-Principles Study of Novel Lead-Free Double Perovskite \b{eta}2SnGeX6 (\b{eta} = K, Rb; X = Cl, Br, I) for thermomechanical, optoelectronic and outstanding thermoelectric applications
...
## 4. Artificial Intelligence for Instability in Inorganic Perovskites: From Mechanism Discovery to Engineering Strategies
...
## 5. Machine learning insights into band gap properties in halide-based perovskites
...
## 6. Charting the thermodynamic stability of hybrid perovskite alloys with machine learning
...
## 9. Equivariant Graph Neural Networks Improve Optical Spectra Prediction for Materials Screening

- Date: 2026-06-17
- Category: Manufacturing and Modules
- arXiv: https://arxiv.org/abs/2606.19133v1
- PDF: https://arxiv.org/pdf/2606.19133v1
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-06-17-arxiv-equivariant_graph_neural_networks_improve_optical_spectra_prediction_for_materials_screeni_infographic.json
...
## 11. Urban Limits as Design Constraints: Identifying Suitable Locations for Distributed, Photovoltaic-Powered Servers

- Date: 2026-06-17
- Category: AI solar cells
- arXiv: https://arxiv.org/abs/2606.18940v1
- PDF: https://arxiv.org/pdf/2606.18940v1
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-06-17-arxiv-urban_limits_as_design_constraints_identifying_suitable_locations_for_distributed_photovol_infographic.json

## 12. More than just light management -- The multiple advantages of nano- and micro-textures in perovskite solar cells
...
## 13. Machine-learned dynamics of surface polarons at reduced oxide surfaces
...
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-06-15-arxiv-twistronic_control_of_shift_current_in_multilayer_moir_system_infographic.json

## 15. Hidden Degradation Costs in Energy-Cost-Only HEMS Optimisation: Study on Battery and PV Sensitivity

- Date: 2026-06-14
- Category: Degradation and Stability
- arXiv: https://arxiv.org/abs/2606.16051v1
- PDF: https://arxiv.org/pdf/2606.16051v1
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-06-14-arxiv-hidden_degradation_costs_in_energy_cost_only_hems_optimisation_study_on_battery_and_pv_sen_infographic.json
...
## 19. Household coping mechanisms under grid failure: Evidence from a high electrification context in Lebanon

- Date: 2026-06-16
- Category: AI solar cells
- arXiv: https://arxiv.org/abs/2606.17807v1
- PDF: https://arxiv.org/pdf/2606.17807v1
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-06-16-arxiv-household_coping_mechanisms_under_grid_failure_evidence_from_a_high_electrification_contex_infographic.json

## 20. Antisite-disorder driven tuning of magnetic properties and exchange-bias in Nd$_{2-x}$Sr$_{x}$CoMnO$_{6-δ}$ $(0 \leq x \leq 1)$ ($δ\sim 0.5$) double perovskites

- Date: 2026-06-15
- Category: Perovskite Solar Cells
- arXiv: https://arxiv.org/abs/2606.17244v1
- PDF: https://arxiv.org/pdf/2606.17244v1
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-06-15-arxiv-antisite_disorder_driven_tuning_of_magnetic_properties_and_exchange_bias_in_nd_2_x_sr_x_co_infographic.json
