...
## 3. Thermal history controls the optoelectronic response of lead halide perovskites through structure and dynamics
...
## 4. Understanding Graphene-Perovskite Interactions: From Flake Chemistry to Crystallisation and Solar Cell Performance
...
## 5. Design and numerical performance analysis of efficient Ag3TaX4 (X = S, Se, Te) thin film solar cells
...
## 6. Machine learning-assisted design and explainable optimization of CdSnP2-based integrated solar-photodetector devices
...
## 7. Polyaniline as a conductive polymer and its role in improving the efficiency and conductivity of perovskite solar cells
...
## 8. LLM-Assisted Behavioural and Scenario Augmentation for Agent-Based Energy Adoption Models

- Date: 2026-09-04
- Category: AI solar cells
- arXiv: https://arxiv.org/abs/2609.04866v1
- PDF: https://arxiv.org/pdf/2609.04866v1
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-09-04-arxiv-llm_assisted_behavioural_and_scenario_augmentation_for_agent_based_energy_adoption_models_infographic.json
...
## 12. What Photocurrent Versus Effective Voltage Tells Us About Charge Generation in Organic Solar Cells

- Date: 2026-09-04
- Category: Organic Photovoltaics
- arXiv: https://arxiv.org/abs/2609.05170v1
- PDF: https://arxiv.org/pdf/2609.05170v1
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-09-04-arxiv-what_photocurrent_versus_effective_voltage_tells_us_about_charge_generation_in_organic_sol_infographic.json

## 13. Reinforcement Learning for Sequential Solar PV Policy Design under Uncertainty: An Agent-Based Approach

- Date: 2026-09-04
- Category: AI solar cells
- arXiv: https://arxiv.org/abs/2609.04880v1
- PDF: https://arxiv.org/pdf/2609.04880v1
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-09-04-arxiv-reinforcement_learning_for_sequential_solar_pv_policy_design_under_uncertainty_an_agent_ba_infographic.json

## 14. Statistical and Deep Learning Approaches for Predicting Degradation of Polymeric Materials in Photovoltaics
...
## 16. Impact of extremely high temperature on future photovoltaic power potential over East Asia

- Date: 2026-09-04
- Category: AI solar cells
- arXiv: https://arxiv.org/abs/2609.04632v1
- PDF: https://arxiv.org/pdf/2609.04632v1
- Infographic JSON: https://dutoaa.github.io/ai-in-solar-cells-progress/infographics/2026-09-04-arxiv-impact_of_extremely_high_temperature_on_future_photovoltaic_power_potential_over_east_asia_infographic.json
...
## 18. Can Strain or Anion Interchange Make an Unstable Structure Stable? Energetics, Lattice Dynamics and Strain-Tunable Band Gaps of Lithium Chalcohalide Antiperovskites (Li$_{3}$$BA$) and their Anion Interchange Variants (Li$_{3}$$AB$)
